...
const examples = {
  ...
  checkbox: require('raw-loader!../examples/checkbox.txt'),
  textinput: require('raw-loader!../examples/textinput.txt'),
  formfield: require('raw-loader!../examples/formfield.txt'),
  ...
  'picker-formlist': require('raw-loader!../examples/picker-formlist.txt'),
